...
func TestDeleteIfNecessary(t *testing.T) {
	...
	tests := []testCase{
		{
			map[string]user{"Erwin": {"Erwin", 143555509, true}, "Levi": {"Levi", 143555509, true}, "Hanji": {"Hanji", 182655545, true}},
			"Erwin",
			"",
			map[string]user{"Levi": {"Levi", 143555509, true}, "Hanji": {"Hanji", 182655545, true}},
			true,
		},
		{
			map[string]user{"Erwin": {"Erwin", 143555509, false}, "Levi": {"Levi", 143555509, false}, "Hanji": {"Hanji", 182655545, false}},
			"Erwin",
			"",
			map[string]user{"Erwin": {"Erwin", 143555509, false}, "Levi": {"Levi", 143555509, false}, "Hanji": {"Hanji", 182655545, false}},
			false,
